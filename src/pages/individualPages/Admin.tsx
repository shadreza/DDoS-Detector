    ...
    <div className="p-2 w-full">
      {
        ...
        <div className="w-full">
            ...
            <div className="flex justify-around items-center w-full mt-6 mb-4">
              {
                adminSettingOptions.map((option, i) => 
                  <Link key={i} to={option.link} className=" hover:animate-pulse border-indigo-500 dark:hover:border-indigo-400 border-2 pl-2 pr-2 pt-1 pb-1 rounded-xl">
